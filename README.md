...
This lightweight server will contain text, code and limited image iconography only. This site will not contain large scale imagery or photography (excluding the Netrunner Card Array)  - Think of this server as the Kindle edition. Where necessary, this server can include relevant links to official sources.

# Netrunner Card Array

The Netrunner Card Array will be installed at the end of each article on this server. This will provide a consistant visual theme, by displaying relevant Netrunner card imagery from NetrunnerDB - prioritising the latest NSG cards where possible.
